            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="{{route('dashboard')}}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{asset('/')}}assets/images/blog.png" alt="" height="62">
                                </span>
                        <span class="logo-lg">
                                    <img src="{{asset('/')}}assets/images/blog.png" alt="" height="57">
                                </span>
                    </a>
                    ...
                    <a href="{{route('dashboard')}}" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                                    <img src="{{asset('/')}}assets/images/blog.png" alt="" height="59">
                                </span>
                    </a>
                </div>
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="email-inbox.html">Add Blog</a></li>
                            <li><a href="email-read.html">Manage Blog</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="email-read.html">Manage Comment</a></li>
                        </ul>
                    </li>
